...
ROD_X_AXIS_DIR_PIN = 1
ROD_X_AXIS_STEP_PWM_CHANNEL = 14

ROD_Y_AXIS_DIR_PIN = 0
ROD_Y_AXIS_STEP_PWM_CHANNEL = 15
...
TAPE_X_AXIS_DIR_PIN = 10
TAPE_X_AXIS_RST_PIN = 11
TAPE_X_AXIS_STEP_PWM_CHANNEL = 4

TAPE_Y_AXIS_DIR_PIN = 8
TAPE_Y_AXIS_RST_PIN = 9
TAPE_Y_AXIS_STEP_PWM_CHANNEL = 3
